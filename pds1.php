											...
											<div class="col-sm-12">
												<div class="tableBG">
													...
													<div class="row">
														<div class="col-sm-3 form-group">
															<label>First Name</label>
															<input id="fbchildFname" data-ignore=1 type="text" placeholder="First Name..." class="form-control" >
														</div>
														<div class="col-sm-3 form-group">
															<label>Middle Name</label>
															<input id="fbchildMname" data-ignore=1 type="text" placeholder="Middle Name..." class="form-control" >
														</div>
														<div class="col-sm-3 form-group">
															<label>Last Name</label>
															<input id="fbchildLname" data-ignore=1 type="text" placeholder="Last Name..." class="form-control" >
														</div>
														<div class="col-sm-3 form-group">
															<label>Birth Date</label>
															<input id="fbchildBirth" data-ignore=1 type="date" placeholder="Birth Date..." class="form-control" >
														</div>
													</div>
													...
													<button id="fbbtnTest" class="btn btn-primary pull-right tblBottom" onClick="saveFam()">Save</button>
									...
									<!-- 	<div class="row">
										...
										<div class="row">
											<div class="col-sm-4 form-group">
												...
												<input id="fbFatherLname" type="text" placeholder="Father's Surename..." class="form-control" required>
											</div>
											<div class="col-sm-4 form-group">
												<label>Firstname</label>
												<input id="fbFatherFname" type="text" placeholder="Firstname..." class="form-control" required>
											</div>
											<div class="col-sm-4 form-group">
												<label>Middlename</label>
												<input id="fbFatherMname" type="text" placeholder="Middlename..." class="form-control" required>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-sm-4 form-group">
												...
												<input id="fbMotherMaiden" type="text" placeholder="Mother's Maidenname..." class="form-control" required>
											</div>
											<div class="col-sm-4 form-group">
												<label>Firstname</label>
												<input id="fbMotherFname" type="text" placeholder="Firstname..." class="form-control" required>
											</div>
											<div class="col-sm-4 form-group">
												<label>Middlename</label>
												<input id="fbMotherMname" type="text" placeholder="Middlename..." class="form-control" required>
											</div>
										</div>
												...
												<div class="tableBG">
													<div class="row">
														<div class="col-md-4 form-group">
															...
															<table id="tblSkill" data-toggle="table"
														   	data-sort-name="no" class="table table-bordered">
																<thead>
																	<tr>
																		<th class="text-center" data-field="hobbies" data-sortable="false">Special Skills / Hobbies</th>
														...
														<div class="col-md-4 form-group">
															...
															<table id="#" data-toggle="table"
														   	data-sort-name="no" class="table table-bordered">
																<thead>
																	<tr>
																		<th class="text-center" data-field="recognition" data-sortable="true">Non-Academic Distinctions / Recognition</th>
															...
															<div class="row">
																<div class="col-sm-12 form-group">
																	<label></label>
																	<input type="text" placeholder="Non-Academic Distinctions / Recognition..." class="form-control" required>
																</div>
															</div>
															<button id="btnDekChild" class="btn btn-danger pull-right tblBottom" style="margin-left: 4px;">Del</button>
															<button id="btnAddChild" class="btn btn-primary pull-right tblBottom">Add</button>
														...
														<div class="col-md-4 form-group">
															...
															<div class="row">
																<div class="col-sm-12 form-group">
																	<label></label>
																	<input type="text" placeholder="Membership in Association / Organization..." class="form-control" required>
																</div>
															</div>
															<button id="btnDekChild" class="btn btn-danger pull-right tblBottom" style="margin-left: 4px;">Del</button>
															<button id="btnAddChild" class="btn btn-primary pull-right tblBottom">Add</button>
...
//ADD DEPENDENTS
	$('#fbbtnAddChild').click(function(){
		...
		var rows = [];
	  	rows.push({
                childFname: '<span class="fbchildFname">'+$('#fbchildFname').val()+'</span>',
                childMname: '<span class="fbchildMname">'+$('#fbchildMname').val()+'</span>',
                childLname: '<span class="fbchildLname">'+$('#fbchildLname').val()+'</span>',
                childBirth: '<span class="fbchildBirth">'+$('#fbchildBirth').val()+'</span>'
            });
